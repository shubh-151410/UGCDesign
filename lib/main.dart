                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Image.asset(imageArray[count])),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          GestureDetector(
                              onTap: () {},
                              child: Container(child: Text(" 23 likes"))),
                          Flexible(
                            child: Align(
                        ...
                        children: <Widget>[
                          GestureDetector(
                            ...
                            child: Row(
                              children: <Widget>[
                                Transform.scale(
                                  scale: handleOutputRangeZoomInIconLike(
                                  ...
                                  child: Transform.rotate(
                                    ...
                                    angle: handleOutputRangeTiltIconLike(
